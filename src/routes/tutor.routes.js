...
const { createTutorValidation, updateTutorValidation } = require('../validations/tutor.validations');
const { validate } = require('../middleware/validate');
const { roles } = require('../constants/sequelizetableconstants');


// Public
router.post('/create', protect, restrictTo(roles.ADMIN), createTutorValidation, validate, tutorController.createtutor);
router.put('/update/:id', protect, restrictTo(roles.ADMIN), updateTutorValidation, validate, tutorController.updatetutor);
